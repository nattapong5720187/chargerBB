...
ev_card   = Image.open("/home/debian/geany_bbb/ev_pic/ev_card2.jpg")
...
def card_show(evant):
	...
	var_card_id = tk.Label(text='12345678',textvariable=varCard_id, font=("Tahoma",20),bg='white',width=30,anchor='w')
	var_card_type = tk.Label(text='Prepaid',textvariable=varCard_type, font=("Tahoma",20),bg='white',width=10,anchor='w')
	var_card_text = tk.Label(text='Prepaid',textvariable=varText, font=("Tahoma",20),bg='white',width=30,anchor='w')
	...
	w.create_window(400,155,window=var_card_id)
	w.create_window(400,220,window=var_card_text)
		...
		if len(serBuffer) == 0:
			...
			if message[0] == 'D2' and length_message ==3 :	#Show Card
				...
				if card_id == '2A958AAB' or card_id == '448A87AB' or card_id == '1A263C06' or card_id == 'E07E6915':
						...
						MysCardid = "Mr. Chaiyong Puapongsakorn"
						MysText = "MEA Governor"
						Mystype = "Prepaid"
					...
					if card_id == '3AF41805' or card_id == '3A1C6206' or card_id == '20F689AB':
							...
							MysStartPrice = 3000.00
							MysCardid = "Mr. Sutee Markboon"
							MysText = "Deputy Minister of Interior"
							Mystype = "Prepaid"
			...
			if message[0] == 'D5' and length_message == 8:	#Energy
				...
				if message[6] == '0':
					...
					varCard_id.set(str(float(energy)/1))
					varText.set(str(float(current) / 100))
					varMoney.set(str(float(price)/100))
					varCard_type.set("")
